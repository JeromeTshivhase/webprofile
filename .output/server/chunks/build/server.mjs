...
import { $ as $fetch$1, w as withQuery, l as hasProtocol, p as parseURL, m as isScriptProtocol, n as joinURL, o as defu, q as sanitizeStatusCode, r as createHooks, h as createError$1, t as isSamePath, v as toRouteMatcher, x as createRouter$1 } from '../runtime.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./contact-ByCZ__J8.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-CDcA6_Ns.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./default-CyYfUUKR.mjs').then((m) => m.default || m)
};
