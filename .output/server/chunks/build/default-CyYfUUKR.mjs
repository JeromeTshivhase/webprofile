...
const _imports_0 = "" + buildAssetsURL("Logo.DAU6WniC.png");
const _sfc_main$2 = {
  data() {
    return {
      isOpen: false
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_nuxt_link, { to: "#home-section" }, {
...
//# sourceMappingURL=default-CyYfUUKR.mjs.map
