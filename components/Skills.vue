<template>
  <section class="relative py-16 bg-white dark:bg-gray-100 overflow-hidden" id="skills-section">
    <!-- Gradients -->
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
      ...
      <div class="relative">
        ...
        <div class="border shadow-lg p-5 rounded-lg bg-white bg-opacity-80 relative z-10">
          <div class="pt-16 flex flex-wrap justify-center gap-6 relative z-10">
            ...
            <div class="bg-gray-100 dark:bg-gray-100 text-center rounded-lg p-4 shadow-md w-full sm:w-1/2 lg:w-1/4 transition-transform transform hover:scale-105 hover:shadow-xl hover:bg-gray-200 dark:hover:bg-gray-200">
              <img src="../assets/icons/java.svg" alt="Java Icon" class="h-12 mx-auto mb-2">
              <h3 class="text-xl font-semibold text-gray-900">Java</h3>
            ...
            <!-- Skill Item -->
            <div class="bg-gray-100 dark:bg-gray-100 text-center rounded-lg p-4 shadow-md w-full sm:w-1/2 lg:w-1/4 transition-transform transform hover:scale-105 hover:shadow-xl hover:bg-gray-200 dark:hover:bg-gray-200">
              <img src="../assets/icons/css.svg" alt="CSS Icon" class="h-12 mx-auto mb-2">
              <h3 class="text-xl font-semibold text-gray-900">CSS</h3>
              <p class="text-gray-600 dark:text-neutral-400">Advanced</p>
            </div>
            <!-- End Skill Item -->
            ...
            <!-- Skill Item -->
            <div class="bg-gray-100 dark:bg-gray-100 text-center rounded-lg p-4 shadow-md w-full sm:w-1/2 lg:w-1/4 transition-transform transform hover:scale-105 hover:shadow-xl hover:bg-gray-200 dark:hover:bg-gray-200">
              <img src="../assets/icons/mariadb.svg" alt="MariaDB Icon" class="h-12 mx-auto mb-2">
            ...
            <div class="bg-gray-100 dark:bg-gray-100 text-center rounded-lg p-4 shadow-md w-full sm:w-1/2 lg:w-1/4 transition-transform transform hover:scale-105 hover:shadow-xl hover:bg-gray-200 dark:hover:bg-gray-200">
              ...
              <h3 class="text-xl font-semibold text-gray-900">Tableau</h3>
